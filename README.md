...
[![GitHub release (latest SemVer including pre-releases)](https://img.shields.io/github/v/release/nekofar/vite-dapp-template?include_prereleases)](https://github.com/nekofar/vite-dapp-template/releases)
[![GitHub Workflow Status (branch)](https://img.shields.io/github/actions/workflow/status/nekofar/vite-dapp-template/build.yml)](https://github.com/nekofar/vite-dapp-template/actions/workflows/build.yml)
[![GitHub](https://img.shields.io/github/license/nekofar/vite-dapp-template)](https://github.com/nekofar/vite-dapp-template/blob/master/LICENSE)
...
This template is designed to streamline the process of creating dApps using Vite.
...
1. On the [repository page](https://github.com/nekofar/vite-dapp-template), click the **Use this template**
   button.
...
the [LICENSE](https://github.com/nekofar/vite-dapp-template/blob/master/LICENSE) file for details.
