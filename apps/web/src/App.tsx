...
import { Card, CardHeader, CardTitle, CardContent, CardFooter, CardDescription } from "@repo/ui/components/card"
      ...
      <main className="container mx-auto p-4 grid gap-6 md:grid-cols-2 lg:grid-cols-3 my-8">
        ...
        <Card className="md:col-span-2 lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Connect your wallet to interact with the dApp</CardDescription>
          </CardHeader>
          <CardContent>
            {account.isConnected ? (
        ...
        <Card className="md:col-span-2 lg:col-span-3">
          <CardContent className="flex flex-col items-center justify-center py-8 space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">Modern web development stack with type safety and beautiful UI</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center justify-center space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold min-w-10 text-center">{count}</span>
              <Button
                variant="outline"
                size="icon"
          ...
          <CardFooter className="text-xs text-muted-foreground text-center">
            Edit <code className="text-xs">src/App.tsx</code> and save to test HMR
          </CardFooter>
        </Card>
      </main>
